...
//          <img
//          src="\Images\Chef_logo_design_vector_illustration__Restaurant_logo-removebg-preview 1.png" 
//          alt=""
//          />
...
//         <div className='butonn-Nav-Filters'>
//             <button >
//             <svg width="18" height="20"  viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
// <path d="M7 3H1" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"/>
// <path d="M11 3H17" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"/>
// <path d="M13 10H1" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"/>
// <path d="M5 17H17" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"/>
// <path d="M5 17C5 15.8954 4.10457 15 3 15C1.89543 15 1 15.8954 1 17C1 18.1046 1.89543 19 3 19C4.10457 19 5 18.1046 5 17Z" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"/>
// <path d="M17 10C17 8.8954 16.1046 8 15 8C13.8954 8 13 8.8954 13 10C13 11.1046 13.8954 12 15 12C16.1046 12 17 11.1046 17 10Z" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"/>
// <path d="M11 3C11 1.89543 10.1046 1 9 1C7.8954 1 7 1.89543 7 3C7 4.10457 7.8954 5 9 5C10.1046 5 11 4.10457 11 3Z" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"/>
// </svg>
...
//         <Navbar.Collapse className='ggg' >
//         <div className='serch-navbar-links'>
//             <div className='serch-nav'>
//     <form>
//             <input type='search' placeholder="Find your favourite meal"  aria-label="Search"/>
...
// </svg> Orders</Nav.Link>
//             <Nav.Link className='navlink-end' href="#Favorites"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
